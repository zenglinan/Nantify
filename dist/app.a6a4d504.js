...
try {
  {
    ...
    vm.$mount();
    var ele = vm.$el.querySelectorAll('use')[1];
...

  {
    ...
    var svg = _vm.$el.querySelectorAll('svg')[1];
...

  {
    ...
    var _svg = _vm2.$el.querySelector('svg > use');
...
},{"vue":"node_modules/vue/dist/vue.common.js","./button":"src/button.vue","./button-group":"src/button-group.vue","chai":"node_modules/chai/index.js","chai-spies":"node_modules/chai-spies/chai-spies.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
