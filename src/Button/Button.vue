...
<style lang="scss" scoped>
  ...
  .c-button {vertical-align: top;display: inline-flex;justify-content: center;
    align-items: center;padding: .5em 1em;font-size: 12px;border-radius: 4px;
    border: 1px solid $border-color;background: $bg;color: $black;outline: none;
    ...
    &.nouse nouse {cursor: not-allowed;color: $gray-light;
